window.addEventListener('DOMContentLoaded', function() {
    ...
    var config = {
        ...
        width: 426,
        height: 240,
        scene: [Boot, Preload, TitleScreen, PauseScene, GuitarRack, UIScene,CutScene1_1, CutScene1_2, CutScene1_3, Level1, Level1BossFight, CutSceneWatermelonDefeated, Stage1_3, Stage1_4, Stage2_1, Stage2_2, Stage3_1, EndCredits],
        physics: {
            default: 'arcade',
            arcade: {
                gravity: { y: 900 },
